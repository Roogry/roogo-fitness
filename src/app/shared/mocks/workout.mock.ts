import { Muscle, Exercise, LoggedSession } from '../types/workout.types';
...
export const mockLoggedWorkoutSessions: LoggedSession[] = [
  {
    ...
    workouts: [
      {
        id: 501,
        logged_session_id: 1001,
        exercise: mockExercises[0],
        sets: [
          { id: 1, logged_exercise_id: 501, set_number: 1, is_warmup: false, reps_completed: 8, weight_lifted: 60 },
          { id: 2, logged_exercise_id: 501, set_number: 2, is_warmup: false, reps_completed: 8, weight_lifted: 65 },
          { id: 3, logged_exercise_id: 501, set_number: 3, is_warmup: false, reps_completed: 6, weight_lifted: 70 },
        ]
      },
      {
        id: 502,
        ...
        sets: [
          { id: 4, logged_exercise_id: 502, set_number: 1, is_warmup: false, reps_completed: 10, weight_lifted: 80 },
          { id: 5, logged_exercise_id: 502, set_number: 2, is_warmup: false, reps_completed: 8, weight_lifted: 90 },
          { id: 6, logged_exercise_id: 502, set_number: 3, is_warmup: false, reps_completed: 8, weight_lifted: 100 },
        ]
      }
    ]
  },
  {
    ...
    workouts: [
      {
        id: 503,
        logged_session_id: 1002,
        exercise: mockExercises[5],
        sets: [
          { id: 7, logged_exercise_id: 503, set_number: 1, is_warmup: false, reps_completed: 10, weight_lifted: 0 },
          { id: 8, logged_exercise_id: 503, set_number: 2, is_warmup: false, reps_completed: 8, weight_lifted: 0 },
        ]
      },
      {
        id: 504,
        ...
        sets: [
          { id: 9, logged_exercise_id: 504, set_number: 1, is_warmup: false, reps_completed: 10, weight_lifted: 40 },
          { id: 10, logged_exercise_id: 504, set_number: 2, is_warmup: false, reps_completed: 8, weight_lifted: 45 },
        ]
      }
    ]
  },
  {
    ...
    workouts: [
      {
        id: 505,
        logged_session_id: 1003,
        exercise: mockExercises[1], // Squat
        sets: [
           { id: 11, logged_exercise_id: 505, set_number: 1, is_warmup: false, reps_completed: 12, weight_lifted: 80 },
           { id: 12, logged_exercise_id: 505, set_number: 2, is_warmup: false, reps_completed: 10, weight_lifted: 90 },
           { id: 13, logged_exercise_id: 505, set_number: 3, is_warmup: false, reps_completed: 8, weight_lifted: 100 },
           { id: 14, logged_exercise_id: 505, set_number: 4, is_warmup: false, reps_completed: 8, weight_lifted: 110 },
        ]
      }
    ]
  }
