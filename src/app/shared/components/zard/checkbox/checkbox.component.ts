...
@Component({
  ...
  template: `
    <main class="relative flex" zardId="checkbox" #z="zardId">
      ...
      <ng-icon
        name="lucideCheck"
        class="text-primary-foreground pointer-events-none absolute top-1/2 left-1/2 flex -translate-1/2 items-center justify-center transition-opacity text-primary-foreground!"
