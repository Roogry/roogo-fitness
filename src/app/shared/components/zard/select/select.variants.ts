...
export const selectVariants = cva(
  mergeClasses(
    'relative inline-block w-full rounded-xl group data-active:border data-active:border-ring data-active:ring-ring/50 data-active:ring-[3px]',
...
export const selectTriggerVariants = cva(
  mergeClasses(
    'flex w-full items-center justify-between gap-2 rounded-xl border border-border bg-transparent',
  ...
  ),
  {
    variants: {
      zSize: {
        ...
        default: 'min-h-12 py-1.5 px-3 text-sm',
...
export const selectContentVariants = cva(
  'z-9999 min-w-full overflow-y-auto rounded-xl border border-border bg-popover text-popover-foreground animate-in fade-in-0 zoom-in-95',
);
export const selectItemVariants = cva(
  'relative flex min-w-full cursor-pointer text-nowrap items-center gap-2 rounded-xl mb-0.5 outline-hidden select-none hover:bg-accent hover:text-accent-foreground data-selected:bg-accent data-selected:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 data-disabled:cursor-not-allowed data-disabled:hover:bg-transparent data-disabled:hover:text-current [&_svg:not([class*="text-"])]:text-muted-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*="size-"])]:size-4',
  {
    variants: {
      zSize: {
