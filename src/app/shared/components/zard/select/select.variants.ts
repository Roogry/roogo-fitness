...
export const selectVariants = cva(
  mergeClasses(
    'relative inline-block w-full rounded-xl group data-active:border data-active:border-border data-active:ring-ring/50 data-active:ring-[3px]',
...
export const selectTriggerVariants = cva(
  mergeClasses(
    'flex w-full items-center justify-between gap-2 rounded-xl border border-border bg-input',
  ...
  ),
  {
    variants: {
      zSize: {
        sm: 'min-h-10 py-2 text-xs px-2',
        default: 'min-h-12 py-2 px-3 text-sm',
        lg: 'min-h-14 py-3 text-base px-4',
      },
    },
    defaultVariants: {
      zSize: 'default',
...
export const selectContentVariants = cva(
  'z-9999 min-w-full overflow-y-auto rounded-xl border bg-popover text-popover-foreground shadow-lg animate-in fade-in-0 zoom-in-95',
);
export const selectItemVariants = cva(
  'relative flex min-w-full cursor-pointer text-nowrap items-center gap-2 rounded-lg mb-0.5 outline-hidden select-none hover:bg-accent hover:text-accent-foreground data-selected:bg-accent data-selected:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 data-disabled:cursor-not-allowed data-disabled:hover:bg-transparent data-disabled:hover:text-current [&_svg:not([class*="text-"])]:text-muted-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*="size-"])]:size-4',
  {
    variants: {
      zSize: {
        sm: 'min-h-10 py-2 text-xs',
        default: 'min-h-12 py-2 text-sm',
        lg: 'min-h-14 py-3 text-base',
      },
      zMode: {
        normal: 'pr-8 pl-2',
        compact: 'pl-6.5 pr-2',
